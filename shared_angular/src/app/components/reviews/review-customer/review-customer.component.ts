...
import template from "@src/app/components/reviews/review-customer/review-customer.component.html";
import styles from "@src/app/components/reviews/review-customer/review-customer.component.css";
